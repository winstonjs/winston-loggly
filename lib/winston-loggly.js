...
Loggly.prototype.query = function (options, callback) {
  var self = this,
      meta = options.meta || this.extractMeta(options),
      context = options.context || this.extractContext(options);
...
Loggly.prototype.formatQuery = function (query) {
  return {
    ...
    context: this.extractContent(options)
  };
};
...
Loggly.prototype.formatResults = function (results, options) {
  return this.sanitizeLogs(results);
};
